...
const HomePage = () => {
  ...
  const title = "Un voyage musical qui réveillera vos sens".split("");
      ...
      >
        ...
        >
          <p>
            ...
            singulière, oscillant entre chants incisifs et slams mélodieux,
            trace la ligne fine entre douceur et intensité. Sur des textes en
            français doux comme percutants, chaque note réchauffe, secoue,
            réveille.
          </p>
          <br />
          <p>
